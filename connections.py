...
class Bg(BaseSlurm):
    ...
    def __init__(self, cluster_user_name, ssh_config_alias, forename_of_user, surname_of_user, user_email, base_output_path, base_runfiles_path, affiliation):
        BaseSlurm.__init__(self, cluster_user_name, ssh_config_alias, forename_of_user, surname_of_user, user_email, base_output_path, base_runfiles_path, 'BlueGem: BrisSynBio, Advanced Computing Research Centre, University of Bristol.', affiliation)
