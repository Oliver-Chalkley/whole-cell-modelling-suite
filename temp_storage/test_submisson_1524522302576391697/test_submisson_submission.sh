...
# Last Updated: 2018-04-23 23:25:02.585230
...
#PBS -o bc3/wcms/out_and_error_files
#PBS -e bc3/wcms/out_and_error_files
...
base_outDir=bc3/wcms/output

# collect the KO combos
ko_list=bc3/wcms/runfiles/ko_sets.list
ko_dir_names=bc3/wcms/runfiles/ko_set_names.list
