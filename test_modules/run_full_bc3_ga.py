...
affiliation = 'full test'

# PATH STUFF
relative_base_that_gets_deleted = 'wcms'
base_path_on_cluster = '/panfs/panasas01/bluegem-flex1/database/wcm_suite/full_test'
output_path = 'output'
...
master_dir = '/panfs/panasas01/bluegem-flex1/database/WholeCell-master'
...
# CREATE GA INSTANCE
ga_inst_UT = genetic_algorithms.Karr2012GeneticAlgorithmGeneKo({'bg': bg_conn}, 'base_mga_unittest_bc3', 'unittest_sim_output', 3, 'stopAtMaxGeneration', {'max_generation': 5}, 'standardGetNewGeneration', standardGetNewGeneration_params_dict, 'standardRunSimulations', {'createJobSubmissionFuncName': 'standardKoSubmissionFunctionUT', 'createJobSubmisions_params_dict': createJobSubmisions_params_dict}, genetic_algorithms.Karr2012MgaBase.getGeneCodesToIdDict(bg_conn, genetic_algorithms.Karr2012MgaBase.getJr358Genes()), '/home/oli/git/published_libraries/whole-cell-modelling-suite/whole-cell-modelling-suite/temp_storage', 'max', 'basicGenomeReductionScore', {'overallScoreFuncName': 'overallScoreBasic', 'rawScoreFunc': mean})
ga_inst_UT.run()
