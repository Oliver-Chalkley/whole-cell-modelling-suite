...
# CREATE GA INSTANCE
ga_inst_UT = genetic_algorithms.Karr2012GeneticAlgorithmGeneKo({'bg': bg_conn}, 'bc3_ga_proper_scoring2', 'unittest_sim_output', 3, 'stopAtMaxGeneration', {'max_generation': 10}, 'standardGetNewGeneration', standardGetNewGeneration_params_dict, 'standardRunSimulations', {'createJobSubmissionFuncName': 'standardKoSubmissionFunction', 'createJobSubmisions_params_dict': createJobSubmisions_params_dict}, 4, genetic_algorithms.Karr2012MgaBase.getGeneCodesToIdDict(bg_conn, genetic_algorithms.Karr2012MgaBase.getJr358Genes()), '/home/oli/git/published_libraries/whole-cell-modelling-suite/whole-cell-modelling-suite/temp_storage', 'max', 'aliveAndSmallestGenome', {'overallScoreFuncName': 'overallScoreBasic', 'rawScoreFunc': mean})
ga_inst_UT.run()
