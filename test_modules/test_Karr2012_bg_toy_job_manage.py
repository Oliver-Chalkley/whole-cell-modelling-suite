...
class Karr2012BgToyManageTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def tearDownClass(cls):
        ...
        print('cls.base_path_on_cluster + \'/\' + cls.relative_base_that_gets_deleted = ', cls.base_path_on_cluster + '/' + cls.relative_base_that_gets_deleted)
#        ls_cmd = ['find ' + cls.base_path_on_cluster + '/' + cls.relative_base_that_gets_deleted + ' -name \'*\'']
#        raw_out = cls.bg_conn.checkSuccess(cls.bg_conn.sendCommand, ls_cmd)
#        print('raw_out = ', raw_out)
    ...
    def test_monitorSubmission(self):
        ...
        test_manager = job_management.SubmissionManagerKarr2012(self.bg_unittest_ko_sub, gene_code_to_id_dict, self.convertDataFunctionName, self.updateCentralDbFunctionName, self.getDataForDbFunctionName, ko_db_path_relative_to_db_connection_flex1 = 'database/ko_db/unittest_ko_db/unittest_ko.db', test_mode = False)
